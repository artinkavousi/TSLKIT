 ...
 */
export const gradientShader: GraphDefinition = {
 ...
 */
export const waveDisplacement: GraphDefinition = {
 ...
 * Fresnel effect
 */
export const fresnelEffect: GraphDefinition = {
  name: 'Fresnel Effect',
 ...
 * UV distortion
 */
export const uvDistortion: GraphDefinition = {
  name: 'UV Distortion',
