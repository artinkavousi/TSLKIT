...
import { float, Fn, sin, ShaderNodeObject, Node } from 'three/tsl';
 ...
 * ```
 */
export const repeatingPattern = Fn<[ShaderNodeObject<Node>, ShaderNodeObject<Node>, ShaderNodeObject<Node>?]>(
