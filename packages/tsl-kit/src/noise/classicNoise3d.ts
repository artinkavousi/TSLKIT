...
import { Fn, abs, dot, float, floor, fract, mix, mod, mul, step, sub, vec2, vec3, vec4, ShaderNodeObject, Node } from 'three/tsl';
 ...
 * ```
 */
export const classicNoise3d = /*#__PURE__*/ Fn<[ShaderNodeObject<Node>]>(([P_immutable]) => {
