...
export interface SkinPreset {
  ...
  shallowScatter: { r: number; g: number; b: number };
  deepScatter: { r: number; g: number; b: number };
 ...
 */
export const fairSkin: SkinPreset = {
  name: 'Fair Skin',
 ...
 */
export const mediumSkin: SkinPreset = {
  name: 'Medium Skin',
 ...
 * Dark/Deep skin tone
 */
export const darkSkin: SkinPreset = {
  name: 'Dark Skin',
 ...
 */
export function getSkinPreset(name: keyof typeof skinPresets): SkinPreset {
