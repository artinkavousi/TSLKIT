...
export interface FabricPreset {
  ...
  // Sheen (for velvet/cloth)
  sheen: number;
  sheenColor: { r: number; g: number; b: number };
  sheenRoughness: number;
  
  // Anisotropy (for silk/satin)
  anisotropy?: number;
 ...
 * Red velvet
 */
export const velvet: FabricPreset = {
  name: 'Velvet',
 ...
 * Blue denim
 */
export const denim: FabricPreset = {
  name: 'Denim',
 ...
 * White silk
 */
export const silk: FabricPreset = {
  name: 'Silk',
 ...
 * Red satin
 */
export const satin: FabricPreset = {
  name: 'Satin',
 ...
 * Canvas fabric
 */
export const canvas: FabricPreset = {
  name: 'Canvas',
 ...
 * Wool (knit)
 */
export const wool: FabricPreset = {
  name: 'Wool',
 ...
 * Leather (smooth)
 */
export const leather: FabricPreset = {
  name: 'Leather',
 ...
 * Suede
 */
export const suede: FabricPreset = {
  name: 'Suede',
 ...
 * Cotton (white)
 */
export const cotton: FabricPreset = {
  name: 'Cotton',
  baseColor: { r: 0.95, g: 0.94, b: 0.92 },
  roughness: 0.9,
  sheen: 0.3,
 ...
 * Linen
 */
export const linen: FabricPreset = {
  name: 'Linen',
 ...
 */
export function getFabricPreset(name: keyof typeof fabricPresets): FabricPreset {
