...
import { simplexNoise4d } from '../../portfolio/noise/simplexNoise4d.js';
 ...
 */
export const curlNoise4d = Fn(([inputA_immutable]: [unknown]) => {
  const inputA = vec4(inputA_immutable).toVar();
  // X
