import { Fn, fract, pow, uniform, smoothstep, length, screenSize } from 'three/tsl';
import { screenAspectUV } from '../../../util/screenAspectUV.js';
 ...
 */
export const lcdEffect = Fn((props: any) => {
