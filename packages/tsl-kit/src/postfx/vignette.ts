...
import { Fn, smoothstep, pow, float, ShaderNodeObject, Node } from 'three/tsl';
 ...
 * ```
 */
export const vignetteEffect = Fn<[ShaderNodeObject<Node>, ShaderNodeObject<Node>?, ShaderNodeObject<Node>?]>(
    ([_uv, smoothing = float(0.45), exponent = float(1.2)]) => {
