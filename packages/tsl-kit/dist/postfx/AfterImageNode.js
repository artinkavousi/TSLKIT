 ...
 * ```
 */
import { TempNode, QuadMesh, RenderTarget, HalfFloatType, NearestFilter } from 'three/webgpu';
import { Fn, vec4, texture, uv, nodeObject } from 'three/tsl';
/**
...
export class AfterImageNode extends TempNode {
     ...
     */
    constructor(textureNode, damp = vec4(0.96)) {
        super('vec4');
    ...
    updateBefore(frame) {
        ...
        material.fragmentNode = Fn(() => {
            ...
            return vec4(current.rgb.mul(vec4(1.0).sub(damping).rgb)
                .add(previous.rgb.mul(damping.rgb)), 1.0);
        })();
 ...
 */
export const afterImage = (texture, damp) => {
