...
import { Fn, vec2, uniform, luminance, max, abs, nodeObject, uv } from 'three/tsl';
/**
...
export class SobelOperatorNode extends TempNode {
     ...
     */
    constructor(textureNode, resolution = uniform(new Vector2())) {
        super('float');
 ...
 * ```
 */
export const sobel = (texture, resolution) => {
