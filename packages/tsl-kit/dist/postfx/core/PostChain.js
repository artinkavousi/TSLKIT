...
export class PostChain {
     ...
     */
    render(renderer, inputBuffer, deltaTime = 0) {
        ...
        for (let i = 0; i < this.passes.length; i++) {
            ...
            // Render the pass
            pass.render(renderer, pass.needsSwap ? this.writeBuffer : null, this.readBuffer, deltaTime);
 ...
 */
export function makePostChain(passes, options = {}) {
