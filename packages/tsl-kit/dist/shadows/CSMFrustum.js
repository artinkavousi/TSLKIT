    ...
    split(breaks, target) {
        ...
        for (let i = 0; i < breaks.length; i++) {
            ...
            for (let j = 0; j < 4; j++) {
                ...
                // Near plane vertices
                vertNear.lerpVectors(this.vertices.near[j], this.vertices.far[j], prev);
                // Far plane vertices
                vertFar.lerpVectors(this.vertices.near[j], this.vertices.far[j], cur);
            }
        }
    }
    /**
