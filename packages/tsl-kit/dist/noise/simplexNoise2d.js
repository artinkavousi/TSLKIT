 ...
 * ```
 */
export const simplexNoise2d = /*#__PURE__*/ Fn(([v_immutable]) => {
    ...
    const p = vec3(permute2d(permute2d(i.y.add(vec3(0.0, i1.y, 1.0)))
        .add(i.x)
        .add(vec3(0.0, i1.x, 1.0)))).toVar();
...
//# sourceMappingURL=simplexNoise2d.js.map