 ...
 */
export function createStorageBuffer(device, label, channels, width, height, depth = 1) {
...
export class UniformBuffer {
    constructor(device, label, name, propDefinitions, props) {
        this.label = label;
    ...
    async update(device, newProps) {
        ...
        device.queue.writeBuffer(this.gpuBuffer, 0, this.arrayBuffer, 0, this.arrayBuffer.byteLength);
    }
}
/**
