 ...
 */
export function generateAdvectionKernel(config) {
    return `
 ...
 */
export function generateDivergenceKernel(config) {
    return `
@group(0) @binding(0) var<storage, read> velocity: array<vec4<f32>>;
 ...
 */
export function generatePressureKernel(config) {
    return `
 ...
 */
export function generateGradientSubtractKernel(config) {
    return `
 ...
 */
export function generateVorticityKernel(config) {
    return `
@group(0) @binding(0) var<storage, read> velocity: array<vec4<f32>>;
