...
import { ForceFieldSystem, GravityForce, AttractorForce, RepulsorForce, VortexForce, CurlNoiseForce, WindForce } from './forces';
/**
 * Earth-like gravity preset
 */
export function earthGravity() {
...
export function tornado() {
    const system = new ForceFieldSystem();
    system.addForce(new VortexForce(new THREE.Vector3(0, 0, 0), new THREE.Vector3(0, 1, 0), 15.0, 100));
...
export function orbitalSystem() {
    const system = new ForceFieldSystem();
    system.addForce(new AttractorForce(new THREE.Vector3(0, 0, 0), 50.0, 200, 1.5));
    return system;
}
/**
...
export function explosion() {
    const system = new ForceFieldSystem();
    system.addForce(new RepulsorForce(new THREE.Vector3(0, 0, 0), 100.0, 150, 2.0));
    return system;
}
/**
...
export function organicFlow() {
    ...
    system.addForce(new WindForce(new THREE.Vector3(1, 0.2, 0.5).normalize(), 2.0, 0.3));
    return system;
}
/**
 * Turbulent atmosphere
 */
export function turbulentWind() {
    const system = new ForceFieldSystem();
    system.addForce(new WindForce(new THREE.Vector3(1, 0, 0), 10.0, 2.0));
 ...
 */
export function multiAttractor() {
    const system = new ForceFieldSystem();
    // Central large attractor
    system.addForce(new AttractorForce(new THREE.Vector3(0, 0, 0), 80.0, 250, 1.8));
    // Orbiting attractors
    system.addForce(new AttractorForce(new THREE.Vector3(50, 0, 0), 20.0, 80, 1.5));
    system.addForce(new AttractorForce(new THREE.Vector3(-50, 0, 0), 20.0, 80, 1.5));
    return system;
}
/**
...
export function chaosField() {
    ...
    system.addForce(new VortexForce(new THREE.Vector3(0, 0, 0), new THREE.Vector3(0, 1, 0), 8.0, 120));
    system.addForce(new WindForce(new THREE.Vector3(1, 0.5, 0.3).normalize(), 5.0, 1.5));
    return system;
}
/**
...
export function magneticField() {
    const system = new ForceFieldSystem();
    // Positive pole
    system.addForce(new AttractorForce(new THREE.Vector3(0, 50, 0), 40.0, 100, 2.0));
    // Negative pole
    system.addForce(new RepulsorForce(new THREE.Vector3(0, -50, 0), 40.0, 100, 2.0));
    return system;
}
/**
...
export function underwaterCurrent() {
    ...
    system.addForce(new WindForce(new THREE.Vector3(0.7, 0.3, 0.5).normalize(), 3.0, 0.8));
