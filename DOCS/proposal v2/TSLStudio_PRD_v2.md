...
- Codex automation tasks share a dedicated schema at `packages/tsl-kit/src/schema/codexTask.schema.json`, exported for agents via `getCodexTaskSchema()`, guaranteeing consistent task ingestion.
