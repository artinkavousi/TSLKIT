...
| **2** | Schema scaffolding | Implement Zod schemas for material/post/compute descriptors, wire DSL compiler stubs; surface Codex automation schema for agent task ingestion.【F:DOCS/proposal v1/tsl-toolkit-architecture.md†L74-L152】【F:packages/tsl-kit/src/schema/codexTask.schema.json†L1-L124】 |
