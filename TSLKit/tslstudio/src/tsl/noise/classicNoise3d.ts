/**
 * Classic 3D Noise (cnoise)
 * 
 * Alternative implementation of 3D Perlin noise
 * 
 * @module tsl/noise/classicNoise3d
 */
...
import { taylorInvSqrt, fade } from './common.js'

/**
 * Local permute function for classic noise
 */
const permuteClassic = /*#__PURE__*/ Fn(
  ([x_immutable]) => {
...
/**
 * Classic 3D Noise Function (cnoise)
 * 
 ...
 * @example
 * ```typescript
 * const noise = cnoise3d(position)
 * ```
 */
export const cnoise3d = /*#__PURE__*/ Fn(
  ([P_immutable]) => {
