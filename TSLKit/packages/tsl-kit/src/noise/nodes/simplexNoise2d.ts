...
import { permute } from './common.js';

type NoiseVec2 = ShaderNodeObject<Node>;

type Simplex2dInputs = [NoiseVec2];

export const simplexNoise2d = /*#__PURE__*/ Fn<ShaderNodeObject<Node>>(([vInput]: Simplex2dInputs) => {
